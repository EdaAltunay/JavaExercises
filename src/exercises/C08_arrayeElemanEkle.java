...
public class C08_arrayeElemanEkle {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(arrayeELemanEkle(eskiArr, istenenEleman)));
    }

    private static int[] arrayeELemanEkle(int[] eskiArr, int istenenEleman) {
