...
public class C07_arrayElemanlariniSagaKaydirma {
 ...
 */
        ...
        System.out.println(Arrays.toString(arrayElemeanlariniSagaKaydirma(arr)));
    }

    public static int[] arrayElemeanlariniSagaKaydirma(int[] arr) {
